-- =========================================================
-- COMPLETE & SAFE SUPABASE SCHEMAS MIGRATION FOR DADACHA DHABA
-- Run this script in your Supabase SQL Editor (https://app.supabase.com)
-- Safe for existing production data: Uses IF NOT EXISTS and non-destructive updates.
-- =========================================================
...
-- Safely add missing product columns
...
-- Safely add missing order columns
